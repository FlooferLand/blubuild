...
// TODO: Rewrite this mess; Old script from the old Blubuild
...
public partial class MechanicalAnimationPlayer : Node {
	...
	[ExportGroup("Local")]
	[Export] public required AudioStream PneumaticFire;
	[Export] public required AudioStream PneumaticRelease;

	readonly Dictionary<StringName, RunningAnimation> activeAnimations = new();
	readonly Dictionary<string, PneumaticAudioPair> pneumaticAudio = new();
	Option<Animation> defaultPose = Option<Animation>.None();
	...
	void AddPneumaticAudioSource(string animName, BoneAttachment3D parent) {
